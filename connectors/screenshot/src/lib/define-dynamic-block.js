...
// SPDX-FileCopyrightText: 2025 Scratch Foundation
//
// SPDX-License-Identifier: AGPL-3.0-only

// Reference: https://github.com/scratchfoundation/scratch-gui/blob/develop/src/lib/define-dynamic-block.js
...
const { ArgumentType, BlockType } = require('scratch-vm');
    ...
    domToMutation: function (xmlElement) {
        ...
        switch (blockInfo.blockType) {
            ...
            case BlockType.EVENT:
                ...
                break;
            default:
                console.warn(`Unknown block type: ${blockInfo.blockType}`);
                break;
        }
...
module.exports = defineDynamicBlock;
